...
d3.csv("scripts/PEV Sales.csv", function(error, data) {
  ...
  y.domain([
    d3.min(brands, function(c) { return d3.min(c.values, function(v) { return v.sales; }); }),
    d3.max(brands, function(c) { return d3.max(c.values, function(v) { return v.sales; }); })
  ]);
